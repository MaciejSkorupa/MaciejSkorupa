		...
		while ( $loop->have_posts() ) : $loop->the_post();
			...
			if( isset($wpb_fp_show_overlay) && $wpb_fp_show_overlay == 'show' ):
				...
				if( isset($wpb_fp_show_links) && $wpb_fp_show_links == 'show' ):
					...
					$output .= '<a class="wpb_fp_preview open-popup-link" href="#wpb_fp_quick_view_'. esc_attr( get_the_id() ) .'" data-effect="'. esc_attr( $wpb_fp_popup_effect ) .'"><i class="fa fa-eye"></i></a>';
